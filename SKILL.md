...
|------|---------|--------------------------------|
| `code_dev` | 软件开发 SOP | 1.需求分析(Coordinator) → 2.并行开发(Developer×N) → 3.集成测试(QA) → 4.代码审查(Reviewer) |
| `deep_research` | 研究报告 SOP | 1.课题拆解(Coordinator) → 2.并行搜索(Researcher×N) → 3.分类整理(Writer×N) → 4.报告合成(Writer) |
  ...
  "tasks": [
    {
      "id": "1",
      "subject": "任务名",
      "role": "developer|researcher|writer|reviewer|qa|architect",
